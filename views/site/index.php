...
<div class="site-index">
    ...
    <div class="jumbotron text-center bg-transparent mt-5 mb-5">
        ...
        <p><a class="btn btn-lg btn-success" href="/article/index">Write an Article</a></p>
    </div>
        ...
        <div class="row">
                ...
                <p>New advances in technology are upending education, from the recent debut of new artificial intelligence (AI) 
                    chatbots like ChatGPT to the growing accessibility of virtual-reality tools that expand the boundaries of the
                     classroom. For educators, at the heart of it all is the hope that every learner gets an equal chance to develop
                      the skills they need to succeed. But that promise is not without its pitfalls..</p>
            ...
            <div class="col-lg-4 mb-3">
                ...
                <p>Universities may be at the cutting edge of research into almost every other field, said Gordon Jones,
                     founding dean of the Boise State University College of Innovation and Design. But when it comes to
            ...
            <div class="col-lg-4">
                ...
                <p>AI is one of several big challenges educators face. Many teachers are learning about this evolving
                     ...
                     on X (formerly Twitter) revealed that 79 percent felt they didn’t know enough about AI to “teach students 
                     how to use it responsibly in a classroom setting as a professional responsibility.” But that’s exactly what
                      a lot of teachers are being asked to do.</p>
